...
import { Bell, Wifi, WifiOff, Sprout, User2, Sun, Moon, Globe } from 'lucide-react';
            ...
            <div className="mx-auto flex h-full max-w-[1480px] items-center justify-between px-4 md:px-6">
                <div className="flex items-center gap-2.5">
                    ...
                    <div className="leading-tight">
                        <p className="font-display text-lg font-bold tracking-tight">{t('agribot')}</p>
                ...
                <div className="flex items-center gap-2 md:gap-3">
                        ...
                        <Tooltip>
                            <TooltipTrigger asChild>
                                ...
                                >
                                    ...
                                    <span className="hidden font-medium sm:inline">{online ? t('online') : t('offline')}</span>
                                    <span
                            ...
                            <TooltipContent>{t('clickToToggle')}</TooltipContent>
                        </Tooltip>
                    </TooltipProvider>
                    ...
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end" className="w-72">
                            <DropdownMenuLabel className="font-display">{t('notifications')}</DropdownMenuLabel>
                            <DropdownMenuSeparator />
                            {notifications.length === 0 && (
                            ...
                            {notifications.slice(0, 4).map((n) => (
                                <DropdownMenuItem key={n.id} className="flex flex-col items-start gap-0.5">
                                    <span className="text-sm font-medium">{n.titleKey ? t(n.titleKey) : n.title}</span>
                                    <span className="line-clamp-2 text-xs text-muted-foreground">{n.bodyKey ? t(n.bodyKey) : n.body}</span>
                                </DropdownMenuItem>
                            ))}
                        </DropdownMenuContent>
                    </DropdownMenu>
                    ...
                    <TooltipProvider delayDuration={150}>
                        <Tooltip>
                            ...
                            <TooltipContent>{language === 'en' ? 'తెలుగు' : 'English'}</TooltipContent>
                        </Tooltip>
                    </TooltipProvider>
                    ...
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end" className="w-44">
                            ...
                            <DropdownMenuItem>{t('devices')}</DropdownMenuItem>
