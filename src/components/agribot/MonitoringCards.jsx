...
export const MonitoringCards = () => {
    ...
    const phToneLabel = ph_.tone === 'optimal' ? t('optimal') : ph_.tone === 'acidic' ? t('acidic') : t('alkaline');
    ...
    const moistureTrend = moisture < 30 ? t('lowIrrigationSuggested') : moisture > 70 ? t('highHoldWatering') : t('withinHealthyBand');
    const tempTrend = temperature > 32 ? t('heatStressRisk') : temperature < 12 ? t('coldStressRisk') : t('comfortableRange');
            ...
            <StatCard
                ...
                trend={
                    <span className="inline-flex items-center gap-1">
                        ...
                        {phToneLabel} · {t('target')} {activeCrop.phMin}–{activeCrop.phMax} {!inRange && `· ${t('outOfRange')}`}
                    </span>
                }
                chartData={phHistory}
                color={phColor}
